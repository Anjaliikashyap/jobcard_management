...
def get_user_jobs():
    try:
        ...
        for job in user_jobs:
            job['_id'] = str(job['_id'])
            job['submission_date'] = job['submission_date'].isoformat() if 'submission_date' in job else None
            job['last_updated'] = job['last_updated'].isoformat() if 'last_updated' in job else None
